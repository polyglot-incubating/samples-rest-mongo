...
//  Predicate<Map.Entry<?, String>> notEmptyMap = e -> e.getValue() != null && !e.getValue().isEmpty();
...
//  static <O, T> Consumer<O> accepting(final BiConsumer<? super O, ? super T> function, final T args) {
