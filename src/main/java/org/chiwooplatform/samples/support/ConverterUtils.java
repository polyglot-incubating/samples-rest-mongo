...
public final class ConverterUtils {
	 ...
	 */
	public static String val(String value, String defaultValue) {
		if (value != null) {
			return value;
		}
		else {
	 ...
	 */
	public static Integer val(Integer value, Integer defaultValue) {
		if (value != null) {
			return value;
		}
		else {
	...
	public static String getFormattedString(final String format, final Date date) {
		...
		return dtm.format(DateTimeFormatter.ofPattern(format));
	}
	...
	static public <T> T toBeanQuietly(Map<String, Object> row, Class<T> clazz) {
		try {
